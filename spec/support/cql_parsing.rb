def extract_cql_values(_cql)
  ...
  when /UPDATE/
  when /INSERT/
    # INSERT INTO cassie_schema.versions (id, version_number, description, migrator, migrated_at) VALUES (09b5cdce-744d-11e6-935f-79233d2548be, '0.1.2', 'some description', 'eprothro', 1473174464000);
