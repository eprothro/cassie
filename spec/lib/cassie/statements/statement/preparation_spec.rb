RSpec.describe Cassie::Statements::Statement::Preparation do
  ...
  after(:each) do
    ...
    Cassie::Statements::Statement::Preparation.cache.clear
  end
  ...
  describe "#statement" do
    ...
    let(:cache){ Cassie::Statements::Statement::Preparation.cache }
